...
function initializeExportFunctionality() {
  ...
  if (selectAllASL) {
    selectAllASL.addEventListener("change", function () {
      const aslCheckboxes = document.querySelectorAll(
        "#asl-table .prescription-select"
      );
  ...
  if (selectAllALR) {
    selectAllALR.addEventListener("change", function () {
      const alrCheckboxes = document.querySelectorAll(
        "#alr-table .prescription-select"
      );
  ...
  const prescriptionCheckboxes = document.querySelectorAll(
    ".prescription-select"
  );
