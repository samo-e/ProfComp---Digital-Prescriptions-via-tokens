...
function handleBulkDelete() {
    ...
    const confirmMessage = 'Are you sure you want to delete ' + checked.length + ' patient(s)?\n\n' +
    ...
    deleteBtns.forEach(function(btn) {
        ...
        if (form) {
            form.addEventListener('submit', function(e) {
                const patientName = form.getAttribute('data-patient-name') || 'this patient';
                const confirmed = confirm('Are you sure you want to delete ' + patientName + '?\n\n' +
