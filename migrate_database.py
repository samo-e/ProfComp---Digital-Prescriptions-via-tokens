...
DB_PATH = os.path.join(os.path.dirname(__file__), 'flaskr', 'instance', 'asl_simulation.db')
...
def migrate_database():
    ...
    try:
        ...
        if 'student_id' not in columns:
            ...
            cursor.execute("ALTER TABLE scenario_patients ADD COLUMN student_id INTEGER")
        ...
        if 'assigned_at' not in columns:
            ...
            cursor.execute("ALTER TABLE scenario_patients ADD COLUMN assigned_at DATETIME")
